'''
Script to evaluate baseline algorithm [1] for interlead conversion.
...
SHARED_ENC = False              # whether or not to use a shared encoder (must match saved model)
